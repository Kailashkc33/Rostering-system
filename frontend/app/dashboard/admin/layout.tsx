...
const navItems = [
  { name: 'Roster Management', href: '/dashboard/admin/roster' },
  { name: 'View Staff', href: '/dashboard/admin/staff' },
  { name: 'View Clock Logs', href: '/dashboard/admin/clock-logs' },
  { name: 'Calculate Payroll', href: '/dashboard/admin/payroll' },
];
        ...
        <nav className="flex flex-col gap-4">
          {navItems.map((item) => (
            <Link
              key={item.href}
              href={item.href}
              className={`px-3 py-2 rounded-lg font-medium transition-colors duration-150 ${
                pathname === item.href
